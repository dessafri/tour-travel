            ...
            <div class="card-body">
                <form action="{{ route('travel-packages.update', $item->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" rows="10" class="d-block w-100 form-control ckeditor">{{ $item->about }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="languages" placeholder="Language" value="{{ $item->languages }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="price_detail">Keterangan</label>
                        <select name="price_detail" id="price detail" class="form-control">
                            <option value="{{$item->price_detail}}">{{$item->price_detail}}</option>
