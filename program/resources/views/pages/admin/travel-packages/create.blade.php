            ...
            <div class="card-body">
                <form action="{{ route('travel-packages.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" rows="10" class="d-block w-100 form-control ckeditor">{{ old('about') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="languages" placeholder="Language" value="{{ old('language') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="price_detail" id="price detail" class="form-control">
                            <option value="">Keterangan Paket</option>
